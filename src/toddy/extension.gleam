...
////
//// Toddy supports two kinds of extensions:
////
//// - **Native widgets**: backed by a Rust crate implementing the
////   `WidgetExtension` trait. The crate is compiled into the toddy
...
/// native widget supports. Used at compile time to configure the toddy
