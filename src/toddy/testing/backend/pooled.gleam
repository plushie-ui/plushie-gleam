...
import toddy/testing/session_pool.{type PoolSubject}
import toddy/tree
...
@external(erlang, "toddy_test_pooled_ffi", "put_pool_session")
fn put_pool_session(pool: PoolSubject, session_id: String) -> Nil

@external(erlang, "toddy_test_pooled_ffi", "get_pool_session")
fn get_pool_session() -> Result(#(PoolSubject, String), Nil)

@external(erlang, "toddy_test_pooled_ffi", "erase_pool_session")
fn erase_pool_session() -> Nil

@external(erlang, "toddy_test_pooled_ffi", "wait_for_interact_response")
