...
pub fn file_exists_returns_false_for_missing_file_test() {
  ffi.file_exists("/tmp/nonexistent_toddy_file_99999")
  |> should.equal(False)
}
...
pub fn get_env_returns_error_for_unset_var_test() {
  ffi.unset_env("TODDY_TEST_NONEXISTENT_VAR_12345")
  ffi.get_env("TODDY_TEST_NONEXISTENT_VAR_12345")
  |> should.be_error
}

pub fn set_and_get_env_round_trips_test() {
  ffi.set_env("TODDY_TEST_FFI_VAR", "hello")
  ffi.get_env("TODDY_TEST_FFI_VAR")
  |> should.equal(Ok("hello"))
  ffi.unset_env("TODDY_TEST_FFI_VAR")
}
